...
describe("assign association class", () => {
  describe("static #reduce", () => {
    it('return a list of reduced fields', () => {
      assert.sameMembers(
        Fields.reduce('test1', 'test1.test2.test3', 'test2.test3.test4', 'test1.test2.test4', 'test1.test2'),
  ...
  describe("get #root", () => {
    it('return a list of root fields', () => {
      const fields = new Fields('test1', 'test1.test2.test3', 'test2.test3.test4', 'test1.test2.test4', 'test1.test2')
